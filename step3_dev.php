						...
						<tr>
							<td height="200" valign="bottom">
								<table width="100%" border="0" cellpadding=" 0" cellspacing="0">
									<tr>
										<td height="45"　class="font_20px">歡迎 , 請選擇請假開始與結束時間
											<font color="red">***請先點選日期,再選擇時間***</font>
										</td>
									</tr>
								...
								<table width="100%" border="0" cellpadding=" 0" cellspacing="0">
									<tr>
										<td height="45" align="left">hoan nghênh, mời bạn lựa chọn thời gian bắt đầu nghỉ và kết thúc
											<font color="red">*** mời bạn ấn ngày tháng, lại lựa chọn thời gian***</font>
										</td>
									</tr>
								...
								<table width="100%" border="0" align="left"" cellpadding=" 0" cellspacing="0">
									<tr>
										<td height="45" align="left">ยินดีต้อนรับสู่ระบบ , โปรดเลือกเวลาเริ่มต้นและเวลาสิ้นสุ
											<font color="red">***โปรดเลือกวันที่ก่อน***</font>
										</td>
									</tr>
									<tr>
										<td>&nbsp;</td>
						...
						<tr>
							<td height="410" valign="top">
								<table width="830" border="0" align="center" cellpadding="0" cellspacing="0" class="font_20px-red">
									<tr>
										<td width="415" valign="bottom">請假起始日期<br> Thời gian bắt đầu <br>เริ่มต้นวันล</td>
										<td width="415" valign="bottom">請假起始時分<br> Thời gian bắt đầu nghỉ từ …h…phút<br>เริ่มเวลาลากี่โมงกี่ </td>
									</tr>
									<tr>
										<td height="45">
									...
									<tr>
										<td>請假截止日期<br>Nghỉ đến ngày<br>สิ้นสุดวันลา</td>
										<td>請假截止時分<br>nghỉ đến…h…phút<br>สิ้นสุดเวลาลากี่โมงกี่</td>
									</tr>
									<tr>
							...
							<td>
								<div>
									<div width="33%" style="display: inline-block;">
										...
										<br>
										<a href="javascript:history.back()">Trở về trang 1</a>
										<br>
										<a href="javascript:history.back()">กลับไปก่อนหน้านี้</a>
									</div>

									<div width="33%" style="display: inline-block;">
										<a href="javascript:;" onClick="document.form.submit();"><img src="image/Sent-out.png" width="179" height="68" border="0" /></a>
										<br>
										<a href="javascript:;" onClick="document.form.submit();">Bấm ok</a>
										<br>
										<a href="javascript:;" onClick="document.form.submit();">ยืนยันเพื่อส่งออ</a>
									</div>
									<div width="33%" style="display: inline-block;">
										<a href="./"><img src="image/select.png" alt="" width="179" height="68" border="0" /></a>
										<br>
										<a href="./">Trở về menu chính</a>
										<br>
